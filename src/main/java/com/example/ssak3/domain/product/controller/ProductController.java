...
public class ProductController {
     ...
     */
    @GetMapping("/products")
    public ResponseEntity<ApiResponse> getProductListApi(@RequestParam(name = "name")String name, @PageableDefault(size = 10, sort = "id", direction = Sort.Direction.DESC)Pageable pageable) {
    ...
    public ResponseEntity<ApiResponse> updateProductApi(@PathVariable Long productId, @RequestBody ProductUpdateRequest request) {
